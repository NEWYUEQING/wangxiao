def set_inference_options(parser):
    ...
    parser.add_argument('-o', '--output_folder', default="/home/username002/dataset/datasets/PHOENIX-2014-T-release-v3/PHOENIX-2014-T-release-v3/PHOENIX-2014-T/features/event_frame", type=str)  # if None, will not write the images to disk
